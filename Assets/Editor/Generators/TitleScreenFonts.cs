...
public static class TitleScreenFonts
{
    ...
    ///
    /// Geometric shapes like U+25C0 are deliberately NOT here - Archivo Black and Saira
    /// have no glyph for them, so baking is refused and the character renders as a box.
    /// The settings BACK arrow uses chevron_select.png instead, as the level-select back
    /// button already does.
    /// </summary>
