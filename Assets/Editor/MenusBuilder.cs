...
public static class MenusBuilder
{
    ...
    static PauseScreen BuildPauseScreen(RectTransform canvas)
    {
        ...
        band.sizeDelta = new Vector2(BandW, BandH);
        ...
        Bind(screen, "group", group);
        Bind(screen, "dim", dimImage);
        Bind(screen, "band", band);
        BindArray(screen, "contentItems", items.ToArray());
    ...
    static EndScreen BuildEndScreen(RectTransform canvas)
    {
        ...
        var columnLabels = new[] { "SURVIVED", "KILLS", "LEVEL", "UPGRADES", "COINS" };
        ...
        Bind(screen, "coinsValue", values[4]);
